...
import com.tananushka.javaadvanced.exception.ErrorDto;
...
public class ErrorController {
    ...
    @ExceptionHandler(JmpException.class)
    public ResponseEntity<ErrorDto> resourceServiceExceptionHandler(JmpException e) {
